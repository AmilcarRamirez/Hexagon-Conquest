...
void nameBase(int, int, char, char array[SIZE][SIZETWO]);
...
void baseEight(char map[SIZE][SIZETWO]) {
  ...
  nameBase(12, 0, name, map);
}

void nameBase(int locationY, int locationX, char name, char map[SIZE][SIZETWO]){
  for (int i = 1; i < 8; i++) {
    switch (i) {
      case 1:
